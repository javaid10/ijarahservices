...
public class ScoringEngine implements JavaService2 {
	...
	String[] EMPLOYER_NAME_FOR_PENSIONERS = { "المؤسسة العامة للتأمينات الإجتماعية -متقاعدين",
			"المؤسسة العامة للتقاعد -متقاعدين" };
	...
	private void createEmployerDetails(Map<String, String> inputParams, DataControllerRequest dataControllerRequest) {
		try {
			ServiceCaller.internalDB(DB_MORA_SERVICES_SERVICE_ID, EMPLOYER_DETAILS_CREATE_OPERATION_ID, inputParams,
