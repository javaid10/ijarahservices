...
public class ServiceCaller {
    ...
    public static Result internalDB(String serviceId, String operationId, Map<String, String> inputParams, FabricRequestManager requestManager, DataControllerRequest dcRequest) {
        ...
        String prefix = "dbxdb_";
        /*
        String prefix = dcRequest != null ?EnvironmentConfigurationsHandler.getValue("SME_SCHEMA_NAME", dcRequest) :
        EnvironmentConfigurationsHandler.getValue("SME_SCHEMA_NAME", requestManager);
         */
